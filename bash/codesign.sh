...
# Signs a Mac binary with the Apple "Developer ID Application" cert
...
APP="/Users/bobosola/rust/media-file-date-fixer/target/universal/mfdf"
...
BUNDLE_ID="uk.org.osola.mfdf"

# Source directory of content to put inside DMG
IMG_SRC="/Users/bobosola/rust/media-file-date-fixer/target/universal"

# Output path and name of DMG
IMG_DEST="/Users/bobosola/Desktop/mfdf.dmg"
