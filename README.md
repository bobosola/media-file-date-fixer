...
The code is most effective when working with media files which have been copied directly from a camera. This is because file metadata can be missing for several reasons, e.g. some online services strip Exif data for privacy reasons, or if the data was removed or changed by an editing application.
