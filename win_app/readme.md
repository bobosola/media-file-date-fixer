...
This is a Visual Studio 2022 WinUI 3 desktop app solution in C#. It requires the `mfdf_ffi.dll` which can be built by
running the appropriate batch file below.
